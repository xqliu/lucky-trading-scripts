#!/usr/bin/env python3
"""Daily recap for OKX ETH BB using current runtime APIs.

Replaces legacy one-liner snippets that used deprecated OKXConfig.from_toml()
loading patterns.
"""
import os
import sys
